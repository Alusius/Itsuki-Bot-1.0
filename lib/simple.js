 ...
 */
    ...
    */
    ...
    reply(jid, text, quoted, options) {
      return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : this.sendMessage(jid, text, MessageType.extendedText, { contextInfo: { mentionedJid: this.parseMention(text), thumbnail: fs.readFileSync('./src/RadBotZ.jpg'), externalAdReply: {title: '──────「©radbotz」──────', body: '@Raditya', sourceUrl: 'https://chat.whatsapp.com/D5IU5pzGDSyE6lAkqqYnvr', thumbnail: fs.readFileSync('./src/RadBotZ.jpg')}}, sendEphemeral: true, quoted, ...options })
    }
