 ...
 */
    ...
    */
    ...
    reply(jid, text, quoted, options) {
      return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : this.sendMessage(jid, text, key : { fromMe: false, participant : `0@s.whatsapp.net` }, message: { documentMessage: { title: 'Uwu.jpeg', jpegThumbnail: fs.readFileSync('./src/RadBotZ.jpg')}}, sendEphemeral: true, quoted, ...options })
    }
