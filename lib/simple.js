 ...
 */
    ...
    */
    ...
    reply(jid, text, quoted, options) {
      return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : this.sendMessage(jid, text, MessageType.extendedText, { contextInfo: { mentionedJid: this.parseMention(text), thumbnail: fs.readFileSync('./src/RadBotZ.jpg'), externalAdReply: {title: 'Raditya', body: '©RadBotZ', sourceUrl: 'https://wa.me/62858929626673?text=Assalamualaikum', thumbnail: fs.readFileSync('./src/RadBotZ.jpg')}}, sendEphemeral: true, quoted, ...options })
    }
