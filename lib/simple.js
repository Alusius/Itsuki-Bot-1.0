 ...
 */
    ...
    */
    ...
    reply(jid, text, quoted, options) {
      return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : this.sendMessage(jid, text, { key: { fromMe: false, remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { message: `©radbotz_1111`, itemCount: 1099, thumbnail: fs.readFileSync('./src/RadBotZ.jpg'), sendEphemeral: true, quoted, ...options })
    }
